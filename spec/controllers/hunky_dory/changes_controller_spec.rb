...
module HunkyDory
  RSpec.describe ChangesController, type: :controller do
    ...
    # a valid Change. As you add validations to Change, be sure to
    ...
    # ChangesController. Be sure to keep this updated too.
    let(:valid_session) { {} }
    ...
    describe 'GET #show' do
      it 'returns a success response' do
        ...
        get :show, params: { id: change.to_param }, session: valid_session
        expect(response).to be_success
      end
    end
    ...
    describe 'GET #edit' do
      it 'returns a success response' do
        change = Change.create! valid_attributes
        get :edit, params: { id: change.to_param }, session: valid_session
        expect(response).to be_success
      end
    end
    ...
    describe 'POST #create' do
      context 'with valid params' do
        ...
        it 'redirects to the created change' do
          post :create, params: { change: valid_attributes },
                        session: valid_session
          expect(response).to redirect_to(Change.last)
        end
      end
    ...
    describe 'PUT #update' do
      context 'with valid params' do
        ...
        it 'updates the requested change' do
          change = Change.create! valid_attributes
          put :update, params: { id: change.to_param, change: new_attributes },
                       session: valid_session
          change.reload
        ...
        it 'redirects to the change' do
          change = Change.create! valid_attributes
          put :update,
              params: { id: change.to_param, change: valid_attributes },
              session: valid_session
      ...
      context 'with invalid params' do
        it "returns a success response (i.e. to display the 'edit' template)" do
          change = Change.create! valid_attributes
          put :update,
              params: { id: change.to_param, change: invalid_attributes },
              session: valid_session
          expect(response).to be_success
        end
      end
    ...
    describe 'DELETE #destroy' do
      it 'destroys the requested change' do
        change = Change.create! valid_attributes
        expect do
          delete :destroy, params: { id: change.to_param },
                           session: valid_session
        end.to change(Change, :count).by(-1)
      end
      ...
      it 'redirects to the changes list' do
        change = Change.create! valid_attributes
        delete :destroy, params: { id: change.to_param }, session: valid_session
        expect(response).to redirect_to(changes_url)
      end
    end
  end
end
